...
// reorder for little endian	  
	...
	public static void main(String[] args)
	{
	    ...
	    for (int i=0; i<16; i++)	System.out.print(Integer.toHexString(0xff&tBuffer[i]).toUpperCase());
	    // for (int i=0; i<16; i++)	System.out.print(Integer.toHexString(0xff&sBuffer[i]).toUpperCase()+" ");
	}
}
